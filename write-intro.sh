...
echo "Backing up current intro.js..."
[ -f app/intro.js ] && cp app/intro.js app/intro.js.bak
...
echo "Done. Two assets still needed:"
echo "1. assets/logo.png  — your FUASK Connect logo, transparent background recommended"
echo "2. assets/intro.mp4 — the AI-generated campus video from Veo"
